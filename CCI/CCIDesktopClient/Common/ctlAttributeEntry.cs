...
{
  public partial class ctlAttributeEntry : UserControl
  {
    ...
    public ctlAttributeEntry()
    {
      InitializeComponent();
      txtEntities.MaxHeight = this.Height - txtEntities.Top;
      txtEntities.ClearSearchWhenComplete = false;
    }
