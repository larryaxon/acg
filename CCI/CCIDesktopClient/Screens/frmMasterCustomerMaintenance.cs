...
namespace CCI.DesktopClient.Screens
{
  public partial class frmMasterCustomerMaintenance : frmEntityMaintenance
  {
    public frmMasterCustomerMaintenance()
    {
      ...
      SrchCustomers.Init("MasterCustomerCustomerList", null);
      SrchCustomers.HiddenColumns.Add("EntityOwner",null);
      lblEntity.Text = "ID";
    }
    public new void Init(string entity) 
    {
      ...
      criteria.Add("EntityOwner", new string[] { Common.ctlSearchGrid.opEQUALS, entity });
