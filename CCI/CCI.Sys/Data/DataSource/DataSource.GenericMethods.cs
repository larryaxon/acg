...
namespace CCI.Sys.Data
{
  public partial class DataSource
  {
    ...
    public CCITable getFieldValidationData()
    {
      ...
      DataSet ds = getDataFromSQL(sql);
      CCITable returnTable = CommonFunctions.convertDataSetToCCITable(ds);
      ds.Clear();
      ds = null;
      return returnTable;
    }
    public CCITable getTableFieldListData(string tableName)
    {
      /*
        alter view vw_DBColumnDetail as
        SELECT OBJECT_SCHEMA_NAME(T.[object_id],DB_ID()) AS [Schema],   
    ...
    #region Utilities
    public string getFormattedFieldValue(string fieldName, int rowIndex, CCITable sourceTable)
    {
