 ...
 */
    public enum UnmatchedNameTypes { Customer, Item, Payor, Carrier, Location, PayCode, TrueUp, ImportCustomer, CityHostedCustomer, Inventory, 
      ...
      MasterProductList, ProductList, CityHostedMRCNetworkInventoryMatch, CityHostedMRCWholesaleMatch, CityHostedLedgerInvoiceMatch, CityHostedLedgerCashMatch, FollowUps, CityHostedCustomersWithMissingInfo, 
      ...
      AnalysisOCCImportRaw, ProcessLog, CityHostedOCCEntry, CityHostedCreditMemos, CityHostedNameMatches, AnalyticsScreen, None};
