...
namespace ACG.DesktopClient.Screens
{
  public partial class frmInvoicePrint : ScreenBase
  {
    ...
    private void frmInvoicePrint_Load(object sender, EventArgs e)
    {
      loadCombos();
      refreshProject();
      srchInvoices.NameType = CommonData.NameTypes.BilledInvoices;
      srchInvoices.Load(CommonData.NameTypes.BilledInvoices, "Billed Invoices");
      srchInvoices.ReLoad();
    }
    private void cboCustomer_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      criteria.Add(CommonData.fieldCUSTOMERID, new string[] { ctlSearchGrid.opEQUALS, cboCustomer.Text });
    ...
    private void refreshProject()
    {
      ...
      context.Add(CommonData.fieldCUSTOMERID, cboCustomer.Text);
    ...
    private void setScreenValuesFromRow(DataGridViewRow row)
    {
      ...
      string customerid = CommonFunctions.CString(row.Cells[CommonData.fieldCUSTOMERID].Value);
