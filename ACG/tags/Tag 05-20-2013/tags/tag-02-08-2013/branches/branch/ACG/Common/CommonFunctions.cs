...
namespace ACG.Common
{
  public class CommonFunctions
  {
    ...
    public static DateTime CDateTime(object o, DateTime defaultValue, string[] validDateFormatList)
    {
      ...
      if (DateTime.TryParseExact(o.ToString(), validDateFormatList, CommonData.cultureInfoUS, System.Globalization.DateTimeStyles.None, out dateTime))
        return dateTime;
      else if (DateTime.TryParseExact(o.ToString(), bigValidDateFormatList, CommonData.cultureInfoUS, System.Globalization.DateTimeStyles.None, out dateTime))
        return dateTime;
    ...
    {
      const string m_ConfigFileName = CommonData.SERVERCONFIGFILENAME;
    ...
    protected static object getDBValue(object def, object src) { return src is DBNull ? def : src; }
