...
//using ACG.Sys.AttributeEngine2.ConvertToEAC;
//using ACG.Sys.AttributeEngine2.Dal;

namespace ACG.Common.SecurityEngine
{
  /// <summary>
  ...
  public class SecurityFactory 
  {
    ...
    private Log log = (Log)LogFactory.GetInstance().GetLog("ACG.Sys.SecurityEngine");
