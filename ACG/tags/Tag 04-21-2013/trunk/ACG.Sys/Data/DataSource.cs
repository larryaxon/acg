...
namespace ACG.Sys.Data
{
  public partial class DataSource : DataAccessBase
  {
    ...
    public DataSet getUnmatchedNames(CommonData.NameTypes type)
    {
      string sql = string.Empty;
      switch (type)
      {
        case CommonData.NameTypes.Customer:
    ...
    //  return getDataFromSQL(sql);
    //}
    public DataSet getSimilarNamesLike(CommonData.NameTypes type, string whereClause)
    {
      string sql = string.Empty;
      switch (type)
      {
    ...
    public DataSet getAllRawData(CommonData.NameTypes type, string whereClause)
    {
      if (whereClause == null)
    ...
    public SortedDictionary<string, string> getResearchFields(CommonData.NameTypes type)
    {
    ...
    public string getMatchedID(string desc, CommonData.NameTypes type)
    {
      string sql = null;
