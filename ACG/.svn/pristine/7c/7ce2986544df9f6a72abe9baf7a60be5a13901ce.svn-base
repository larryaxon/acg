...
namespace TAGBOSS.Common.Logging
{
  /// <summary>
  ...
  public class Log : ILog
  {
    ...
    /// </summary>    
    public enum LogContext { Tagboss = 1000, Common, CommonInterface, Logging, Model, Services, Sys, AttributeEngine, Config, Dal, Dictionary, EntityAttribute, EventTransaction, Interface, Note, TransactionEngine, Workflow, Action };
