...
{
  public class SearchDataSourceCISEmployees: DataAccessBase, ISearchDataSource
  {
    ...
    public SearchDataSourceCISEmployees()
    {
      OrderByClause = " ORDER BY LastName ";
      IDName = "EmployeeID";
      NameName = "EmployeeName";
    ...
    {
      return string.Format(@"SELECT EmployeeID, IsNull(LastName,'') + ', ' + IsNull(FirstName,'') As EmployeeName, Role, StartDate, EndDate FROM Employees");
    }
