...
{
  public class ACGTable : ACGFormItem, IComparable, IEquatable<ACGTable>, IComparable<ACGTable>
  {
    ...
    private Dictionary<int, Dictionary<string, Hashtable>> pickLists = new Dictionary<int, Dictionary<string, Hashtable>>();
    ...
    public Hashtable getPickList(int row, string column)
    {
    ...
    public void setPickList(int row, string column, Hashtable table)
    {
      ...
      {
        Dictionary<string, Hashtable> newRow = new Dictionary<string, Hashtable>(StringComparer.CurrentCultureIgnoreCase);
    ...
    public int CompareTo(object o)
    {
      if (o == null)
        return 1;
      if (o.GetType() == typeof(ACGTable))
        return CompareTo((ACGTable)o);
      throw new Exception("Must compare to an ATKTable object");
    }
    public int CompareTo(ACGTable table)
    {
      if (table == null)
        return 1;
      if (table.ID == null)
    ...
    public bool Equals(ACGTable table)
    {
