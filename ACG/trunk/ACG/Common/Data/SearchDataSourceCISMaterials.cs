...
{
  public class SearchDataSourceCISMaterials: DataAccessBase, ISearchDataSource
  {
    ...
    public SearchDataSourceCISMaterials()
    {
      OrderByClause = " ORDER BY MaterialID ";
      IDName = "MaterialID";
      NameName = "MaterialName";
    ...
    {
      return string.Format(@"SELECT MaterialID, MaterialName, MaterialDescription, Price  FROM Materials");
    }
