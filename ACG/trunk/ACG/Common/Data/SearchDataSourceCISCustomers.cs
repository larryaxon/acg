...
{
  public class SearchDataSourceCISCustomers: DataAccessBase, ISearchDataSource
  {
    ...
    public SearchDataSourceCISCustomers()
    {
      OrderByClause = " ORDER BY CustomerID ";
      IDName = "CustomerID";
      NameName = "CustomerName";
