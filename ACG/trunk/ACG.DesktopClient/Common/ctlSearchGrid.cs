...
namespace ACG.DesktopClient.Common
{
  public partial class ctlSearchGrid : UserControl
  {
    ...
    private ACGCommonData.NameTypes _nameType;
    ...
    public ACGCommonData.NameTypes NameType 
    { 
    ...
    public bool DisplaySearchCriteria { get { return !splitMain.Panel1Collapsed; } set { splitMain.Panel1Collapsed = !value; btnCollapseSearch.Text = value ? "<" : ">"; } }
    ...
    public void Load(ACGCommonData.NameTypes nameType, string name)
    {
      _name = name;
      NameType = nameType;
      loadSearch();
    ...
    {
      CommonFormFunctions.copyTableContents(grdResearch);
    }
